...
export const FORM_LOCATION_AUTH_HINT = '无法获取当前位置，请确认已授权位置权限'
...
export const FORM_SEARCH_MONTH = '搜索月份...'
export const FORM_SEARCH_YEAR = '搜索年份...'
export const FORM_SEARCH_USER = '搜索用户名/邮箱...'
export const FORM_SEARCH_TXN_DESC = '搜索交易描述...'
export const FORM_EMAIL_VALID_REQUIRED = '请输入有效的邮箱地址'
export const FORM_CAPTCHA_DIGITS_REQUIRED = '请输入6位验证码'
