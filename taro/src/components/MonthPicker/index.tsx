...
import {
  buildMonthPickerChevronClassName,
  buildMonthPickerClassName,
...
export default function MonthPicker({
  ...
  return (
    <View className={buildMonthPickerClassName({ className })}>
      <Picker
        mode="date"
        fields="month"
        value={pickerValue}
      ...
      >
          <View className="month-picker-inner">
            ...
            <Icon name="chevron-down" size={24} color={light ? ICON_COLOR.onPrimary : ICON_COLOR.muted} className={buildMonthPickerChevronClassName({ light })} />
          </View>
        </Picker>
    </View>
  );
