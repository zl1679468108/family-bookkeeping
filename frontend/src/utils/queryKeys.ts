...
/** 切换账本时需要失效的资源根 key */
export const BOOK_SCOPED_ROOT_KEYS: readonly QueryKey[] = [
...
/** 登录/登出/切账号时清理的业务缓存根 */
export const USER_SCOPED_ROOT_KEYS: readonly QueryKey[] = [
  queryKeys.books.all,
  queryKeys.transactions.all,
  queryKeys.statistics.all,
  queryKeys.budgets.all,
...
export const TRANSACTION_IMPACT_ROOT_KEYS: readonly QueryKey[] = [
  queryKeys.transactions.all,
  queryKeys.statistics.all,
  queryKeys.budgets.all,
  queryKeys.map.all,
