...
- Name: reports.spec.ts >> 统计报表 - 真实数据 >> 查看收支概览
- Location: e2e/reports.spec.ts:19:7
...
Locator: locator('text=支出')
Expected: visible
Error: strict mode violation: locator('text=支出') resolved to 2 elements:
    1) <div class="stat-card__label">本月支出</div> aka getByText('本月支出')
    2) <div class="empty-state__desc">设置预算可以更好地控制支出</div> aka getByText('设置预算可以更好地控制支出')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for locator('text=支出')
